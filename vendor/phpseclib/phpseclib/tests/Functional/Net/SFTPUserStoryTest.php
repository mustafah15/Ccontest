    ...
    */
    public function testPwdHome($sftp)
    {
        $this->assertEquals(
            ...
            $sftp->pwd(),
            'Failed asserting that pwd() returns layout directory after login.'
        );
    ...
    */
    public function testChDirScratch($sftp)
    {
        ...
        $this->assertStringStartsWith(
            $this->getEnv('SSH_HOME'),
            $pwd,
            'Failed asserting that the layout directory is a prefix of the ' .
    ...
    */
    public function testChDirUpHome($sftp)
    {
        ...
        $this->assertEquals(
            $this->getEnv('SSH_HOME'),
            $sftp->pwd(),
            'Failed asserting that pwd() returns layout directory.'
        );
